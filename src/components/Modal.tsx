...
function Modal({mode = 'dark', onClose, ...props}: ModalType)
{
    ...
    return <div className="fixed top-0 left-0 bg-black/25 w-screen h-screen flex items-center justify-center z-50 p-4">
        <div className={`modal ${mode} drop-shadow-xl ${mode === 'dark' ? 'bg-menu text-white' : 'bg-white'} p-4 rounded-lg w-full max-w-lg max-h-[90vh] overflow-y-auto`}>
